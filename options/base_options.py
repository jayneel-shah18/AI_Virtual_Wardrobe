...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize', type=int, default=512,
                                 help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=512,
                                 help='then crop to this size')
        self.parser.add_argument('--label_nc', type=int, default=20,
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='AI_Virtual_Wardrobe/Data_preprocessing/')
        ...
        self.parser.add_argument('--nThreads', default=1, type=int,
    ...
    def parse(self, save=True):
        ...
        # Set GPU device only if CUDA is available and GPU ID is valid
